    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-1 p-1 bg-bg-surface rounded-xl border border-white/[0.06] w-fit">
        {(['clients', 'leads'] as Tab[]).map(t => (
          ...
          >
            {t === 'clients' ? <><Building2 className="w-3.5 h-3.5 inline mr-1.5" />Clients</> : <><TrendingUp className="w-3.5 h-3.5 inline mr-1.5" />Leads</>}
          </button>
        ))}
      </div>
              ...
              return (
                <div key={status} className="min-w-[200px]">
                  ...
                  <div className="space-y-2">
                    {loading ? (
                      Array.from({length: 2}).map((_,i) => <div key={i} className="kanban-card"><Skeleton lines={3} /></div>)
                          ...
                          <div className="flex gap-1 mt-2">
                            {status !== 'won' && (
                              <button
                                ...
                                className="text-[10px] text-brand-green hover:text-white bg-brand-green/10 hover:bg-brand-green/30 px-2 py-0.5 rounded transition-colors"
                              >
                            ...
                            <button
                              ...
                              className="text-[10px] text-text-tertiary hover:text-accent-red px-1 py-0.5 rounded transition-colors"
                            >
                              ✕
                            </button>
                          </div>
